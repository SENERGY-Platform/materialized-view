...
func GetSorted(target string, endpoint string, query url.Values, jwt jwt_http_router.Jwt, limit string, offset string, orderBy string, asc bool) (result []interface{}, err error) {
	result = []interface{}{}
	l, err := strconv.Atoi(limit)
	if err != nil {
		return result, err
